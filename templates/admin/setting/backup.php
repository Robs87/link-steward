...
<div class="layui-row content-body place-holder">
    ...
    <div class="layui-col-lg12">
      <div class="page-msg">
        <ol>
          <li>您可以对数据库进行本地备份和回滚</li>
          <li>备份数据库仅保存最近10份数据</li>
          <li>该功能仅辅助备份使用，无法确保100%数据安全，因此定期对整个站点打包备份仍然是必要的</li>
          <li>如果您需要迁移数据，步骤为：立即备份 > 下载备份到本地 > 新安装 Link Steward > 上传备份 > 回滚</li>
        </ol>
      </div>
    </div>
    <!-- 说明提示框END -->
  ...
  layui.use(['table','upload'],function(){
    ...
    upload.render({
      ...
      before: function(obj){ // 选择文件后
        ...
        // 得到文件名
        let name = file.name;
          // 兼容旧备份前缀，推荐新备份使用 link_steward_202312071528_0.9.32.db3
          let reg = /^(onenav|link_steward)_[0-9]{12}_[0-9]{1,2}\.[0-9]{1,2}\.[0-9]{1,2}\.db3$/;
          if( !reg.test(name) ) {
